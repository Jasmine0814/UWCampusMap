...
public class Path<E> implements Iterable<Path<E>.Segment> {
    ...
    /**
     * The ordered sequence of segments representing a path between object.
     */
    ...
    /**
     * Segment represents a single segment as part of a longer, more complex path between object.
